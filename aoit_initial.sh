...
echo "## SSH Key for aoitsrvmgmt by aoitnetworks.com\nssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIPoZeXjFs9OefIc76bnWBdylFR2mJh74I3NeiZEw5sy5 aoitsrvmgmt@aoitnetworks" >> ~/.ssh/authorized_keys
